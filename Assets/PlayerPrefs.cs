...
public class PlayerPrefsEditor : EditorWindow
{
    ...
    void OnGUI()
    {
        ...
        if (!lockFile && GUILayout.Button("Save to file")) PlayerPrefs.SaveReal();

        if (GUILayout.Button("Delete All"))
        {
            if (EditorUtility.DisplayDialog("Are you sure?", "This will delete all your keys.", "I am 100% sure."))
